//
//  MovieThumbRequestViewController.m
//  AllSmallDemo
//
...
#import "MovieThumbRequestViewController.h"
#import <MediaPlayer/MediaPlayer.h>
@interface MovieThumbRequestViewController ()
@property (nonatomic,strong) MPMoviePlayerController *moviePlayer;//视频播放控制器
@end
@implementation MovieThumbRequestViewController
#pragma mark - 控制器视图方法
- (void)viewDidLoad {
    [super viewDidLoad];
    //播放
