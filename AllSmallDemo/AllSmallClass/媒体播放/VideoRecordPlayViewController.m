//
//  VideoRecordPlayViewController.m
//  AllSmallDemo
//
...
#import "VideoRecordPlayViewController.h"
#import <MobileCoreServices/MobileCoreServices.h>
#import <AVFoundation/AVFoundation.h>

@interface VideoRecordPlayViewController ()<UIImagePickerControllerDelegate,UINavigationControllerDelegate>
...
@implementation VideoRecordPlayViewController

#pragma mark - 控制器视图事件
- (void)viewDidLoad {
    [super viewDidLoad];
    _photo = [[UIImageView alloc]initWithFrame:CGRectMake(0, TopHeight, APPW, APPH-2*TopHeight)];
    UIButton *take = [[UIButton alloc]initWithFrame:CGRectMake(20, YH(_photo), APPW-40, 30)];
    [take setTitle:@"开始拍摄" forState:UIControlStateNormal];
    [take addTarget:self action:@selector(takeClick:) forControlEvents:UIControlEventTouchUpInside];
    take.backgroundColor = redcolor;
    [self.view addSubviews:_photo,take,nil];
    //通过这里设置时拍照还是录制视频
    _isVideo=YES;//NO;
}
