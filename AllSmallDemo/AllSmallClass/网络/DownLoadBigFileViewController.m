//
//  DownLoadBigFileViewController.m
//  AllSmallDemo
//
...
#import "DownLoadBigFileViewController.h"
#import "DACircularProgressView.h"

@interface DownLoadBigFileViewController () <NSURLConnectionDataDelegate>
...
@implementation DownLoadBigFileViewController

- (void)viewDidLoad
{
    [super viewDidLoad];
    UIButton *down = [[UIButton alloc]initWithFrame:CGRectMake(50, 300, 100, 100)];
    [down setTitle:@"下载" forState:UIControlStateNormal];
    [down setTitle:@"暂停" forState:UIControlStateSelected];
    ...
    circleView.progress = 0.50000001;
