...
//        [self.navigationController.navigationBar setFrame:CGRectMake(0, 0,APPW, TopHeight)];
        [[UINavigationBar appearance] setBackIndicatorImage:[[UIImage imageNamed:@"u_white_cell_left"]imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal]];
        [[UINavigationBar appearance] setBackIndicatorTransitionMaskImage:[[UIImage imageNamed:@"u_white_cell_left"]imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal]];
    ...
    [self.navigationController.navigationBar setBarTintColor:GLOBALColor];
}
...
- (BaseViewController*)pushController:(Class)controller withInfo:(id)info withBlock:(id)block{
    BaseViewController *con = [[controller alloc]init];
    con.block = block;
    con.userInfo = info;
