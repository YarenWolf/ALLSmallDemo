...
+ (UIColor *)randomColor {
	return [UIColor colorWithRed:(CGFloat)RAND_MAX / arc4random()
						   green:(CGFloat)RAND_MAX / arc4random()
							blue:(CGFloat)RAND_MAX / arc4random()
						   alpha:1.0f];
}
...
+(UIColor*)colorFromHex:(NSString*)hexString{
    return [self colorFromHex:hexString alpha:1];
}
